...
(function () {
	...
	class VkSiteProcessor extends SiteProcessor {
		...
		processPage() {
			hideBySelector(element, "[class*=stories_feed]", "stories feed");
			hideBySelector(element, "[class*=FeedSkeleton__storyList]", "stories feed skeleton");
